...
public class Member {
	...
	public Member(String id, String name, String pwd, String gender, String birthdate, String tel, String email,
			String con_past, String con_date, String con_cat, String position, Date regdate) {
		this.id = id;
		this.name = name;
		this.pwd = pwd;
		this.gender = gender;
